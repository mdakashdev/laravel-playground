...
> cache remember and forgot keno kori ?

frequently change hoi ha emon data gulo amra cache kore rakhi jeno database a na jete hoi, tahole faster hoi. cache to amra akta time maintain kori.
jodi sei time par hoi tobe se abar new vabe cache kore rakhbe frob db theke but

amar cache korar time er moddhe sei endpoint er data gulo change hoi, tobe to update data pabo na. ta solution hocche
jei jei jaigai updage or changes er kichu kori tar por e forgot use kora. mane cache delete kore deya 
